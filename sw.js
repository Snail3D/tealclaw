...
self.addEventListener('fetch', e => {
  ...
  if (e.request.url.includes('/api/') || e.request.url.includes('groq.com') || e.request.url.includes('openrouter.ai') || e.request.url.includes('elevenlabs.io') || e.request.url.includes('api.telegram.org') || e.request.url.includes('anthropic.com') || e.request.url.includes('together.xyz') || e.request.url.includes('fal.run') || e.request.url.includes('fireworks.ai') || e.request.url.includes('openai.com')) {
